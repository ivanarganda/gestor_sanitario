    ...
    <div class="w-full bg-gray-100 dark:bg-gray-800 bg-opacity-80 p-8 rounded-lg shadow-md transition-all duration-500 ease-in-out">
        <form action="{{ url('/login') }}" id="loginForm" method="POST" class="grid gap-8 w-full transition-all duration-500 ease-in-out">
            ...
            <div id="access_buttons" class="flex flex-col items-center space-y-6 {{ $errors->has('email') || $errors->has('password') ? 'hidden' : '' }}">
                <div id="buttonAccessAdmin" data-value="admin" class="cursor-pointer access-button bg-blue-500 text-white flex items-center justify-center space-x-2">
                    ...
                    <span id="buttonAccessAdmin">Acceso administradores</span>
                </div>
                <div id="buttonAccessMEDATS" data-value="medats" class="cursor-pointer access-button bg-green-500 text-white flex items-center justify-center space-x-2">
                    ...
                    <span id="buttonAccessMEDATS">Acceso Médicos o ATS</span>
                </div>
                <div id="buttonAccessUser" data-value="user" class="cursor-pointer access-button bg-green-500 text-white flex items-center justify-center space-x-2">
                    ...
                    <span id="buttonAccessUser">Acceso empleados</span>
                </div>
            </div>
            ...
            <div id="input_labels" class="{{ $errors->has('email') || $errors->has('password') ? '' : 'hidden' }}">
                ...
                <div class="space-y-2">
                    ...
                    <input class="h-10 w-full border rounded-lg p-2 text-sm bg-gray-100 dark:bg-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all duration-500 ease-in-out" id="email" name="email" placeholder="john@example.com" type="text" />
                </div>
